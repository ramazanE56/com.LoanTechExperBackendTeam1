Feature: API_US011 : As an administrator, I want to access the list of categories via API connection.
  ...
  Scenario Outline: TC03: Verify the information returned in the request for the entity with id(x) (name, image, description, status, created_at, updated_at)
    ...
    Then Verify the information of the one with the id  in the API admin response body: <dataIndex>, "<name>",  "<image>",  "<description>", "<status>",  "<created_at>", "<updated_at>"


    Examples:
      | dataIndex | name   | image | description                                   | status | created_at                | updated_at |
      | 0         |Car Loan|null   |If you want to buy a car, this loan is for you.|1       |2023-12-28T11:12:02.000000Z|2023-12-28T11:12:02.000000Z|