Feature: US_06: As a user, I want to be able to update the user profile information in the system through API connection.
  ...
  the remark information in the request body is "failed"
    ...
    Given The API user sets "user/profile" path parameters
    And The API user saves the response from the user ticket close endpoint with valid authorization information
    And The API user prepares a PATCH request with valid authorization information incomplete data (firstname, lastname, address, state, zip, city)
    When The API user sends a PATCH request and saves the response from the user ticket add endpoint with valid authorization information
    Then The API user verifies that the status code is 203
    And The API user verifies that the message information in the response body is "failed"
  ...
  status code is 203, and the remark information in the request body is "failed"
    ...
    Given The API user sets "user/profile" path parameters
    And The API user saves the response from the user ticket close endpoint with valid authorization information
    And The API user prepares a PATCH request with valid authorization information empty body (firstname, lastname, address, state, zip, city)
    When The API user sends a PATCH request and saves the response from the user ticket add endpoint with valid authorization information
    Then The API user verifies that the status code is 203
    And The API user verifies that the message information in the response body is "failed"
  ...
  status code is 401, and the error message in the request body is "Unauthorized request"
    ...
    Given The API user sets "user/profile" path parameters
    And The API user saves the response from the user ticket close endpoint with valid authorization information
    And The API user prepares a PATCH request with invalid authorization information and correct data (firstname, lastname, address, state, zip, city)
    When The API user sends a PATCH request and saves the response from the user ticket add endpoint with valid authorization information
